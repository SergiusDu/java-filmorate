...
class FilmorateApplicationTest {
    ...
    class UserTests {
        @Test @DisplayName("Should create user successfully")
        ...
        @Test @DisplayName("Should fail to create user with invalid login")
        void invalidLogin() {
        ...
        @Test @DisplayName("Should fail to create user with invalid email")
        void invalidEmail() {
        ...
        @Test @DisplayName("Should fail to create user with future birthday")
        void futureBirthday() {
        ...
        @Test @DisplayName("Should update existing user")
        void updateUser() {
        ...
        @Test @DisplayName("404 on update unknown user")
        void updateNotFound() {
        ...
        @Test @DisplayName("Should get all users")
        void getAllUsers() {
    ...
    class FriendshipTests {
        @Test @DisplayName("Add and pending friend")
        void addFriend() {
        ...
        @Test @DisplayName("Confirm friendship")
        ...
        @Test @DisplayName("Remove friend")
        void removeFriend() {
            UserResponse u1 = createUser(new CreateUserRequest("u1@u.com","u1","U1",LocalDate.of(1991,1,1)));
            UserResponse u2 = createUser(new CreateUserRequest("u2@u.com","u2","U2",LocalDate.of(1992,2,2)));
            restTemplate.put("/users/{id}/friends/{f}", null, u1.id(), u2.id());
        ...
        @Test @DisplayName("Get common friends")
        void commonFriends() {
            UserResponse u1 = createUser(new CreateUserRequest("u1@u.com","u1","U1",LocalDate.of(1991,1,1)));
            UserResponse u2 = createUser(new CreateUserRequest("u2@u.com","u2","U2",LocalDate.of(1992,2,2)));
    ...
    class FilmTests {
        ...
        @Test @DisplayName("Blank name fails")
        void blankName() {
        ...
        @Test @DisplayName("Long description fails")
        void longDesc() {
        ...
        @Test @DisplayName("Invalid release date fails")
        void invalidDate() {
        ...
        @Test @DisplayName("Negative duration fails")
        ...
        @Test @DisplayName("Get popular films")
        void getPopular() {
        ...
        @Test @DisplayName("Get common films")
        void commonFilms() {
            UserResponse u1 = createUser(new CreateUserRequest("u1@u.com","u1","U1",LocalDate.of(1990,1,1)));
    ...
    class MpaTests {
        ...
        @Test @DisplayName("Get MPA by ID")
        void getMpaById() {
        ...
        @Test @DisplayName("404 on unknown MPA")
        void mpaNotFound() {
    ...
    class GenreTests {
        @Test @DisplayName("Get all Genres")
        void getAllGenres() {
            ResponseEntity<GenreResponse[]> resp = restTemplate.getForEntity("/genres", GenreResponse[].class);
            assertThat(resp.getBody()).hasSize(6)
                    .extracting("name").contains("Комедия","Драма","Мультфильм","Триллер","Документальный","Боевик");
        }
        @Test @DisplayName("Get Genre by ID")
        void getGenreById() {
        ...
        @Test @DisplayName("404 on unknown Genre")
        void genreNotFound() {
    ...
    class ReviewTests {
        ...
        @Test @DisplayName("Create review")
        ...
        @Test @DisplayName("Update review")
        ...
        @Test @DisplayName("Get review by id and params")
        ...
        @Test @DisplayName("Delete review")
        ...
        @Test @DisplayName("Reaction flow")
        void reactionFlow() {
            ReviewResponse r = createReview(new CreateReviewRequest("good", true, user.id(), film.id()));
            int init = r.useful();
            ...
            assertThat(restTemplate.exchange("/reviews/{id}/like/{u}", HttpMethod.PUT, null, Void.class, r.reviewId(), user.id()).getStatusCode())
    ...
    class EventFeedTests {
        ...
        @Test @DisplayName("Should return 7 events chronologically")
        void feedEvents() {
    ...
    class MostPopularTests {
        ...
        void prep() {
            ...
            like(f1,u1); like(f1,u2); like(f2,u1); like(f2,u3); like(f3,u1);
            like(f4,u1); like(f4,u3); like(f5,u1); like(f5,u2); like(f5,u3);
        }

        @Test @DisplayName("Top 2 for genre 1/year 1990")
        void topByGenreYear() {
            like(f1,u1); like(f1,u2); like(f2,u1);
        ...
        @Test @DisplayName("Filter by genre only")
        void byGenre() {
        ...
        @Test @DisplayName("Filter by year only")
        void byYear() {
            ResponseEntity<FilmResponse[]> resp = restTemplate.getForEntity("/films/popular?year=2000", FilmResponse[].class);
            assertThat(resp.getBody()).hasSize(3);
        }

        @Test @DisplayName("Invalid count throws")
        void invalidCount() {
            Assertions.assertThrows(RestClientException.class, () ->
                restTemplate.getForEntity("/films/popular?count=-1", FilmResponse[].class));
        }

        @Test @DisplayName("Invalid year throws")
        void invalidYear() {
            int ny = LocalDate.now().getYear()+1;
            Assertions.assertThrows(RestClientException.class, () ->
                restTemplate.getForEntity("/films/popular?year="+ny, FilmResponse[].class));
            Assertions.assertThrows(RestClientException.class, () ->
                restTemplate.getForEntity("/films/popular?year=1850", FilmResponse[].class));
        }

        @Test @DisplayName("Unknown genre yields empty")
        void unknownGenre() {
    ...
    class RecommendationTests {
        @Test @DisplayName("Recommend based on similar user")
        void recommend() {
        ...
        @Test @DisplayName("Apply filters in recommendations")
        ...
        @Test @DisplayName("No likes returns empty")
        void noLikes() {
        ...
        @Test @DisplayName("No similar user returns empty")
        void noSimilar() {
            UserResponse u1 = createUser(new CreateUserRequest("u1@u.com","u1","U1",LocalDate.of(1990,1,1)));
